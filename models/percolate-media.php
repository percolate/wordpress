 ...
 public function addAdminScripts () {
  ...
  //  }
   ...
   $scripts[] = array(
     ...
     'src'		 => plugins_url( '/js/media/app.js', dirname(__FILE__) ),
     'deps'		 => array('angular'),
     'version' => '1',
     'footer'  => true
   );
   $scripts[] = array(
     'handle'	 => 'MediaCtr',
     'src'		 => plugins_url( '/js/media/controllers/media.js', dirname(__FILE__) ),
     'deps'		 => array('angular'),
     'version' => '1',
     'footer'  => true
   );
   $scripts[] = array(
     'handle'	 => 'LoaderDirM',
     'src'		 => plugins_url( '/js/media/directives/loader.js', dirname(__FILE__) ),
     'deps'		 => array('angular'),
     'version' => '1',
     'footer'  => true
   );
   ...
   wp_enqueue_style( 'percolate-styles-media', plugins_url( '/styles/css/percolate-media.css', dirname(__FILE__) ), null, '1', 'all' );
 }
